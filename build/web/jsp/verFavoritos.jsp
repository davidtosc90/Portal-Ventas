    ...
    <body>
        ...
        <div id="contenedor">
            ...
            <article id="principal">
                ...
                <div class="col-sm-8">
                    <br/>
                    <h1>Mis artículos de interés</h1>
                    <hr>
                    <div>
                        <form>
                            <fieldset class="form-group">
                                ...
                                <input type="button" id="bold" class="btn-primary" value="Filtrar" onclick="filtrarFav();" />
                    ...
                    <div id="respuesta">
                        <c:choose>
                            <c:when test="${!empty sessionScope.fav}">
                                <table class="table table-responsive table-hover">
                                    ...
                                    <tbody>
                                        <c:forEach var="art" items="${sessionScope.fav}">
                                            <tr>
                                                <td>${art.codPostal}</td>
                                                <td>${art.categoria}</td>
                                                <td>${art.nombre}</td>
